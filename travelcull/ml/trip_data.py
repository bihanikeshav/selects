...
state directory (``<photo folder>/.travelcull/``) with travel-generic defaults
...
into your own ``.travelcull/`` directory to customize.
"""
...
# examples/ladakh/tag_prompts.json into your .travelcull/ to restore those.
