...
def run_embedding_stage(cfg, on_progress=None, batch_size=16):  # noqa: F811
    ...
    from selects.ml.embed import run_embedding_stage as _fn
...
def run_tag_stage(cfg, on_progress=None, top_k=3, min_score=0.0, tag_prompts=None):  # noqa: F811
    """Lazy proxy: imports selects.ml.tags.run_tag_stage on first call."""
    from selects.ml.tags import run_tag_stage as _fn
...
def run_story_stage(cfg, on_progress=None):  # noqa: F811
    """Lazy proxy: imports selects.ml.stories.run_story_stage on first call."""
    from selects.ml.stories import run_story_stage as _fn
    return _fn(cfg, on_progress=on_progress)


def run_face_embedding_stage(cfg, on_progress=None):  # noqa: F811
    """Lazy proxy: imports selects.ml.faces.run_face_embedding_stage on first call."""
    from selects.ml.faces import run_face_embedding_stage as _fn
    return _fn(cfg, on_progress=on_progress)


def run_face_attribute_stage(cfg, on_progress=None):  # noqa: F811
    """Lazy proxy: imports selects.ml.face_attributes.run_face_attribute_stage on first call."""
    from selects.ml.face_attributes import run_face_attribute_stage as _fn
    return _fn(cfg, on_progress=on_progress)


def run_moment_stage(cfg, on_progress=None):  # noqa: F811
    """Lazy proxy: imports selects.ml.moments.run_moment_stage on first call."""
    from selects.ml.moments import run_moment_stage as _fn
    return _fn(cfg, on_progress=on_progress)
