...
Aggregates every per-day :class:`~selects.db.models.Story` in the library
(the "day-by-day" narrative rows built by :mod:`selects.ml.stories` — day
...
since a selects library is one folder == one trip.
"""
