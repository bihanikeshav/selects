...
# NOTE: SigLIP measures *semantic* similarity, so different subjects shot at the
# same spot/framing score high and get wrongly grouped (0.94 over-grouped badly).
# 0.97 keeps true burst/near-identical shots while dropping most different-subject
# collisions. The proper fix is a perceptual hash (pHash/dHash) — TODO in the
